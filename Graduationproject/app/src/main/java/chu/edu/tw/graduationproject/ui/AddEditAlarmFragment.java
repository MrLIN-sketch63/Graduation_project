...
import chu.edu.tw.graduationproject.service.AlarmReceiver;
import chu.edu.tw.graduationproject.service.LoadAlarmsService;
import chu.edu.tw.graduationproject.util.ViewUtils;
...
public class AddEditAlarmFragment extends Fragment {
    ...
    private ImageButton save_alarm, delete_alarm;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        save_alarm = v.findViewById(R.id.save_alarm);
        delete_alarm = v.findViewById(R.id.delete_alarm);
