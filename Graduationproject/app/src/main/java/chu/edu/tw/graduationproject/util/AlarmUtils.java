package chu.edu.tw.graduationproject.util;

import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_FRI;
import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_IS_ENABLED;
import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_LABEL;
import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_MON;
import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_SAT;
import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_SUN;
import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_THURS;
import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_TIME;
import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_TUES;
import static chu.edu.tw.graduationproject.data.DatabaseHelper.COL_WED;
import static chu.edu.tw.graduationproject.data.DatabaseHelper._ID;
    ...
    public static ArrayList<Alarm> buildAlarmList(Cursor c) {
        ...
        if (c.moveToFirst()){
            do {
                ...
                final long time = c.getLong(c.getColumnIndexOrThrow(COL_TIME));
                final String label = c.getString(c.getColumnIndexOrThrow(COL_LABEL));
                final boolean mon = c.getInt(c.getColumnIndexOrThrow(COL_MON)) == 1;
                final boolean tues = c.getInt(c.getColumnIndexOrThrow(COL_TUES)) == 1;
                final boolean wed = c.getInt(c.getColumnIndexOrThrow(COL_WED)) == 1;
                final boolean thurs = c.getInt(c.getColumnIndexOrThrow(COL_THURS)) == 1;
                final boolean fri = c.getInt(c.getColumnIndexOrThrow(COL_FRI)) == 1;
                final boolean sat = c.getInt(c.getColumnIndexOrThrow(COL_SAT)) == 1;
                final boolean sun = c.getInt(c.getColumnIndexOrThrow(COL_SUN)) == 1;
                final boolean isEnabled = c.getInt(c.getColumnIndexOrThrow(COL_IS_ENABLED)) == 1;
